...
export class CreateTipsTable2026012600000 implements MigrationInterface {
    name = 'CreateTipsTable2026012600000'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create foreign key when the referenced table is already present.
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // Drop indexes
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_tips_tx_id"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_tips_confession_id"`);
