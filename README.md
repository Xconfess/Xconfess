...
GrantFox campaign contributors should start with the
[GrantFox Contributor Guide](docs/GRANTFOX_CONTRIBUTOR_GUIDE.md) before picking
up issues labeled `GrantFox OSS` and `Official Campaign`.
